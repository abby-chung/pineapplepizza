const e=[{id:10,title:"《海風酒店》：每一樣巨大的物事總會讓你失望",slug:"the-sea-breeze-club-review",excerpt:"不是閱讀心得，更不是書評，單純只是想寫下來，因為要寫下來，才會記得。",content:`
      <div class="image-container">
          <img src="/pineapplepizza/images/posts/books/taitung-sansiantai.webp" alt="Taitung" class="blog-image" />
          <p class="image-caption">註：這是台東的照片，《海風酒店》的地點是設在花蓮秀林鄉和平村。</p>
      </div>
      <p>當初在選要從吳明益老師的哪一本作品開始閱讀時，單純只是被《海風酒店》的封面和書名吸引，然後想要好好閱讀一本長長的小說，過去幾年來的讀物多為短篇，想要坐下來花好幾個小時、好幾天，進入一個世界，參與角色們的人生</p>
      ...
      <p>其實在閱讀到小說後半時，我腦袋一直會回想到這段在小說前段寫到的，對每個人來說，<i>蓋水泥廠換到了什麼？不蓋水泥廠又換到了什麼？</i>很喜歡這邊關於「交換」的敘述，也是當提到《海風酒店》時，我第一個會閃過腦海的片段，也許是因為所有的人際關係，是靠不間斷的交換形成的，而關係破碎的時候，總是來自於「對交換有所欲求」，而那份「期待」並沒有被滿足的失落。</p>
      <div class="image-container">
    ...
    `,date:"February 4, 2026",readTime:"6 min read",language:"中文",tags:["Books","Journal"],author:"Abby Chung"},{id:9,title:"Mazu Pilgrimage: Religion, Faith and Belief",slug:"mazu-pilgrimage",excerpt:"Contemplations on participating in a Mazu pilgrimage event in Taiwan.",content:`
      <div class="image-container">
    ...
    `,date:"December 18, 2025",readTime:"3 min read",language:"EN",tags:["Photography","Journal"],author:"Abby Chung"},{id:8,title:"Python 入門工作坊：心得小筆記",slug:"python-workshop",excerpt:"在此小小紀錄 PyLadies Kaohsiung 在高雄舉辦 Python 工作坊的心得，順便督促自己好好複習。😓",content:`
    ...
    `,date:"November 30, 2025",readTime:"2 min read",language:"中文",tags:["Learning","Journal"],author:"Abby Chung"},{id:7,title:"AWS Kiro AI IDE 初體驗：咖啡筆記小工具 Coffee Brew Notes",slug:"vibe-coding-with-kiro",excerpt:"第一次嘗試 AI-native IDE，見識一下 👻 Kiro spec-driven 的開發能力，並結合 Supabase 及 Vercel 來開發小工具。",content:`
      <div class="image-container">
    ...
    `,date:"November 20, 2025",readTime:"13 min read",language:"中文",tags:["Vibe Coding","Learning"],author:"Abby Chung",featured:!0,featuredOrder:1},{id:6,title:"Building an Expense Logger: Track Spending via Text Messages",slug:"automation-expense-logger",excerpt:"Automation with Make AI - exploring the automation process.",content:`
    ...
    `,date:"September 30, 2025",readTime:"7 min read",language:"EN",tags:["Automation","Learning"],author:"Abby Chung",featured:!0,featuredOrder:2},{id:5,title:"First Take on Voigtländer Color-Skopar 18mm F2.8 with Fujifilm X-T4",slug:"voigtlander-lens-with-fujifilm",excerpt:"Walking on the street of New York on a cold December, is it a bad idea to use a manual focus lens?",content:`
    ...
    `,date:"September 22, 2025",readTime:"4 min read",language:"EN",tags:["Photography"],author:"Abby Chung",featured:!0,featuredOrder:3},{id:4,title:"Vibe Coding 筆記：Pineapple Pizza 的誕生故事",slug:"building-blog-vibe-coding-adventure",excerpt:"Vibe Coding 經驗分享和為自己留下的筆記，此次嘗試的目標是藉由 GenAI 產出一個「能看且能用」的部落格網站，也就是現在看到的 Pineapple Pizza。",content:`
    ...
    `,date:"August 17, 2025",readTime:"12 min read",language:"中文",tags:["Vibe Coding","Learning"],author:"Abby Chung",featured:!0,featuredOrder:4},{id:3,title:"Perfect Days -《我的完美日常》電影心得",slug:"perfect-days-review",excerpt:"電影系列決定以《我的完美日常》作為開場，這部電影也最符合近期人生階段，對生活的一些想法。",content:`
    ...
    `,date:"September 20, 2025",readTime:"5 min read",language:"中文",tags:["Movies"],author:"Abby Chung"},{id:2,title:"Book Review: The Seven Husbands of Evelyn Hugo",slug:"seven-husbands-evelyn-hugo-review",excerpt:"A compelling tale of ambition, love, and the price of fame that kept me turning pages well into the night.",content:`
    ...
    `,date:"September 5, 2025",readTime:"6 min read",language:"EN",tags:["Books"],author:"Claude"},{id:1,title:"手沖咖啡之旅：新手村",slug:"pour-over-coffee-beginners-journey",excerpt:"愛上咖啡是條不歸路。咖啡雖續命，但需要更努力工作才能買得起咖啡。歡迎一起面對買咖啡所造成的財務危機。",content:`
    ...
    `,date:"August 15, 2025",readTime:"4 min read",language:"中文",tags:["Coffee","Journal"],author:"Abby Chung"}];export{e as b};
